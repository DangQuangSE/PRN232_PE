...
Chạy script [`database.sql`](../../../given_pe_trial_practice/SetB_Ecommerce_Update/1/database.sql) (thư mục given) trên SQL Server trước khi làm bài (tạo database `PE_Practice_EcommerceB` kèm dữ liệu mẫu).
...
The API at url **`/api/designer/create`**, method **POST**, inserts a new designer:
- Request body:
  ```json
  {
    "fullName": "Dummy Designer",
    "male": true,
    "dob": "1990-10-22",
    "nationality": "USA",
