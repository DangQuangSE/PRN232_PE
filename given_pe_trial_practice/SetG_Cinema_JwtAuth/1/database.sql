USE [master]
GO
CREATE DATABASE [PE_Practice_CinemaG]
GO
USE [PE_Practice_CinemaG]
GO
...
-- Account table backing the JWT login endpoint (Question 1.3)
...
-- Login accounts backing Question 1.3 (POST /api/auth/login)
-- NOTE: plain-text passwords for exam simplicity only — never do this in production.
SET IDENTITY_INSERT [dbo].[Accounts] ON
INSERT [dbo].[Accounts] ([Id],[Username],[Password],[Role]) VALUES
(1, 'admin', 'Admin@123', 'Admin'),
(2, 'staff', 'Staff@123', 'User')
