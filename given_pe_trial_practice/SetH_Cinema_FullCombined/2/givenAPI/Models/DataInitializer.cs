...
namespace givenAPI.Models
{
    public static class DataInitializer
    {
        ...
        // 5. Movies (a few extra titles per director so Search has something to filter)
        public static List<Movie> Movies = new List<Movie>
        {
            ...
            new Movie { Id = 3, Title = "Interstellar", ReleaseDate = new DateTime(2014, 11, 7), Description = "A team of explorers travel through a wormhole in space.", Language = "English", ProducerId = 4, DirectorId = 1 },
            new Movie { Id = 4, Title = "Jurassic Park", ReleaseDate = new DateTime(1993, 6, 11), Description = "A theme park with cloned dinosaurs goes wrong.", Language = "English", ProducerId = 2, DirectorId = 2 },
            new Movie { Id = 5, Title = "E.T. the Extra-Terrestrial", ReleaseDate = new DateTime(1982, 6, 11), Description = "A boy befriends a stranded alien.", Language = "English", ProducerId = 2, DirectorId = 2 },
            new Movie { Id = 6, Title = "Parasite", ReleaseDate = new DateTime(2019, 5, 30), Description = "A poor family schemes to become employed by a wealthy family.", Language = "Korean", ProducerId = 3, DirectorId = 3 },
            new Movie { Id = 7, Title = "Snowpiercer", ReleaseDate = new DateTime(2013, 8, 1), Description = "The last survivors of a frozen world live aboard a perpetually moving train.", Language = "English", ProducerId = 3, DirectorId = 3 },
            new Movie { Id = 8, Title = "Zero Dark Thirty", ReleaseDate = new DateTime(2012, 12, 19), Description = "The decade-long hunt for Osama bin Laden.", Language = "English", ProducerId = 4, DirectorId = 4 },
            new Movie { Id = 9, Title = "Barbie", ReleaseDate = new DateTime(2023, 7, 21), Description = "Barbie and Ken venture from Barbieland to the real world.", Language = "English", ProducerId = 5, DirectorId = 5 },
            new Movie { Id = 10, Title = "Lady Bird", ReleaseDate = new DateTime(2017, 11, 3), Description = "A teenager navigates a turbulent relationship with her mother.", Language = "English", ProducerId = 5, DirectorId = 5 }
        };
